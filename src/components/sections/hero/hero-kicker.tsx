...
export function HeroKicker() {
  ...
  const baseTransition = {
    delay: reduceMotion || skipEntry ? 0 : 1.2,
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 top-24 z-20 flex items-start justify-between px-4 sm:top-28 sm:px-6 lg:px-8">
      <motion.div
