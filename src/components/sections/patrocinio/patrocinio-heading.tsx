...
/**
 * PatrocinioHeading — replica o padrão de SobreHeading com:
 *
 *   1. "05" gigante de fundo (z=0), estático
 *   2. Kicker editorial slide-in lateral ("05 / Para sua marca")
 *   3. Heading "Para sua marca" char-by-char clip-path mask reveal
 *   4. Slash vermelho cresce horizontal em sequência
 *   5. Subtítulo com fade + slight rise
 *   6. Linha decorativa horizontal abaixo, desenhando 0→100%
 */
export function PatrocinioHeading() {
  ...
  return (
    <div ref={ref} className="relative isolate">
      ...
      >
        <span className="text-racing-red">05</span>
        <motion.span
          aria-hidden
          initial={{ scaleX: 0 }}
      ...
      <motion.p
        ...
        className="relative z-10 mt-6 max-w-2xl font-heading text-base font-medium uppercase tracking-[0.2em] text-racing-blue-bright lg:text-lg"
      >
        {PATROCINIO_COPY.subtitle}
      </motion.p>
